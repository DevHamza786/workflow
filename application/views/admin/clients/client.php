                    ...
                    <div class="tw-space-x-3 tw-flex tw-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <?php /* "Login as client" option removed
                                <?php if (is_admin()) { ?>
                                <li>
            ...
            <div class="tw-mt-12 sm:tw-mt-0 <?php echo isset($client) ? 'col-md-9' : 'col-md-8 col-md-offset-2'; ?>">
                <div class="panel_s">
                    ...
                    <div class="panel-footer text-right tw-space-x-1" id="profile-save-section">
                        <?php /* "Save and create contact" button removed
                        if (!isset($client)) {
                            echo '<button class="btn btn-default save-and-add-contact customer-form-submiter">' . _l('save_customer_and_add_contact') . '</button>';
                        }
                        */ ?>
