    ...
    <nav>
        <div class="tw-flex tw-justify-between">
            <div class="tw-flex tw-flex-1 sm:tw-flex-initial">
                ...
                <ul class="nav navbar-nav visible-md visible-lg" style="display: none !important;">
                    <?php
                ...
                ?>
                    ...
                    if (isset($item['href_attributes'])) {
                        foreach ($item['href_attributes'] as $key => $val) {
                            ...
                            <li>
                                <a href="<?php echo e($url); ?>" <?php echo e($href_attributes); ?>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if (is_staff_member()) { ?>
                <li class="icon header-newsfeed" style="display: none !important;">
                ...
                <li class="icon header-todo" style="display: none !important;">
