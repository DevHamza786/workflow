         ...
         <div class="modal-body">
            ...
            <div id="bulk_change">
               ...
               <?php if (staff_can('edit',  'tasks')) { ?>
                  ...
                  $staff_bulk_assigned = format_staff_for_dropdown($staff_bulk_assigned);
                  echo render_select('task_bulk_assignees', $staff_bulk_assigned, ['staffid', 'fullname', 'department_name'], 'task_assigned', '', ['multiple' => true]);
                  if (isset($project)) {
